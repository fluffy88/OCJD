...
public class DataClassTest {
	...
	private static final Data dataService = new Data();
	...
	private class UpdatingRandomRecordThread extends Thread {
		...
		public void run() {
			String[] data = new String[] { "Palace", "Smallville", "Testing", "5", "$0", "" };
	...
	private class UpdatingRecord1Thread extends Thread {
		...
		public void run() {
			String[] data = new String[] { "Castle", "Digitopolis", "Testing", "5", "$0", "" };
	...
	private class CreatingRecordThread extends Thread {
		...
		public void run() {
			String[] data = new String[] { "Elephant Inn", "EmeraldCity", "Testing", "5", "$0", "" };
	...
	private class FindingRecordsThread extends Thread {
		...
		public void run() {
			try {
				...
				final String[] criteria = { "Palace", "Smallville", null, null, null, null };
				final int[] results = dataService.find(criteria);
				...
				for (int i = 0; i < results.length; i++) {
					...
					try {
						...
						final String[] room = dataService.read(results[i]);
